package cn.hankchan.utils.unique;

import cn.hankchan.utils.SystemCurrentTimeUtils;
 ...
 * <p>得到的值，这里的的开始时间截，一般是我们的id生成器开始使用的时间，由我们程序来指定的（如下下面程序IdWorker类的startTime属性）。41位的时间截，可以使用69年</p>
...
public class SnowflakeIdWorker {
	...
	protected long timeGen() {
		return SystemCurrentTimeUtils.now();
	}
